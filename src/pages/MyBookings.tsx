...
const MyBookings = () => {
  ...
  const [bookingToCancel, setBookingToCancel] = useState<typeof initialBookings[0] | null>(null);
      ...
      <div className="container mx-auto px-4 py-12">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          <TabsList className="grid w-full max-w-2xl mx-auto grid-cols-4 glass-card p-2">
            <TabsTrigger value="all" className="data-[state=active]:bg-gradient-gold">All</TabsTrigger>
            <TabsTrigger value="upcoming" className="data-[state=active]:bg-gradient-gold">Upcoming</TabsTrigger>
            <TabsTrigger value="completed" className="data-[state=active]:bg-gradient-gold">Completed</TabsTrigger>
            <TabsTrigger value="cancelled" className="data-[state=active]:bg-gradient-gold">Cancelled</TabsTrigger>
          </TabsList>
        ...
        <Dialog open={cancelDialogOpen} onOpenChange={setCancelDialogOpen}>
          <DialogContent className="glass-card">
            <DialogHeader>
              ...
              <DialogDescription>
                Are you sure you want to cancel your booking for <strong>{bookingToCancel?.car}</strong>? This action cannot be undone.
              </DialogDescription>
            </DialogHeader>
